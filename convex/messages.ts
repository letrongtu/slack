...
export const getById = query({
  ...
  handler: async (ctx, args) => {
    ...
    const reactionWithoutMemberIdProp =
...
export const get = query({
  ...
  handler: async (ctx, args) => {
    ...
    const results = await ctx.db
      .query("messages")
      .withIndex(
        "by_channel_id_parent_message_id_convesation_id",
        (q) =>
          q
